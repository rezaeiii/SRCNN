...
parser = argparse.ArgumentParser(description='an implement of SRCNN')
parser.add_argument('--dataset', type=str, default='data/91-image/' ,help='dataset directory for traning')
parser.add_argument('--test', type=str, default='data/Set5/' ,help='dataset directory for traning')
...
if __name__ == "__main__":
    ...
    write_hdf5(data, label, "crop_train-91-image-scale3.h5")
    data, label = prepare_data(TEST_PATH)
    write_hdf5(data, label, "ok-test-set5-scale3.h5")
